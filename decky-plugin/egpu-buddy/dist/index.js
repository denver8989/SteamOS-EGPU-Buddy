...
function Content() {
    ...
    SP_REACT.useEffect(() => { if (!visible)
        return; refresh(); const t = setInterval(refresh, 3000); return () => clearInterval(t); }, [visible]);
