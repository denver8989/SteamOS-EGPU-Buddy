...
const listVersions = callable("list_versions");
const installVersion = callable("install_version");
...
function Content() {
    ...
    const [vers, setVers] = SP_REACT.useState(null);
